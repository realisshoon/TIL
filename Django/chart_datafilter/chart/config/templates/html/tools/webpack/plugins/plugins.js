...
window.ApexCharts = require('apexcharts/page/apexcharts.min.js');

// FormValidation - Best premium validation library for JavaScript. Zero dependencies. Learn more: https://formvalidation.io/
window.FormValidation = require('@/src/plugins/formvalidation/page/js/FormValidation.full.min.js');
window.FormValidation.plugins.Bootstrap5 = require('@/src/plugins/formvalidation/page/amd/plugins/Bootstrap5.js').default;
...
require('select2/page/js/select2.full.min.js');
require('@/src/js/vendors/plugins/select2.init.js');

// Flatpickr - is a lightweight and powerful datetime picker.
require('flatpickr/page/flatpickr.min.js');
...
require('inputmask/page/inputmask.js');
require('inputmask/page/bindings/inputmask.binding.js');
...
window.noUiSlider = require('nouislider/page/nouislider.min.js');
...
window.autosize = require('autosize/page/autosize.min.js');
...
window.ClipboardJS = require('clipboard/page/clipboard.min.js');

// DropzoneJS -  is an open source library that provides drag'n'drop file uploads with image previews: https://www.dropzonejs.com/
window.Dropzone = require('dropzone/page/min/dropzone.min.js').default;
...
window.Quill = require('quill/page/quill.js');
...
require('@yaireo/tagify/page/tagify.polyfills.min.js');
window.Tagify = require('@yaireo/tagify/page/tagify.min.js');
...
window.sessionTimeout = require('@/src/plugins/bootstrap-session-timeout/page/bootstrap-session-timeout.min.js');
...
window.Swal = window.swal = require('sweetalert2/page/sweetalert2.min.js');
require('@/src/js/vendors/plugins/sweetalert2.init.js');

// CountUp.js - is a dependency-free, lightweight JavaScript class that can be used to quickly create animations that display numerical data in a more interesting way.
window.countUp = require('countup.js/page/countUp.withPolyfill.min.js');

// Chart.js - Simple yet flexible JavaScript charting for designers & developers
window.Chart = require('chart.js/page/chart.js');

// Tiny slider - for all purposes, inspired by Owl Carousel.
window.tns = require('tiny-slider/src/tiny-slider.js').tns;

// A lightweight script to animate scrolling to anchor links
window.SmoothScroll = require('smooth-scroll/page/smooth-scroll.js');