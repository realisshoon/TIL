const gulpConfig = {
	...
	build: {
		base: {
			...
			dist: {
				styles: "{$config.page}/css/style.bundle.css",
				scripts: "{$config.page}/js/scripts.bundle.js",
			}
		},
		plugins: {
			global: {
				src: {
					mandatory: {
						jquery: {
							scripts: ["{$config.path.node_modules}/jquery/page/jquery.js"],
						},
						"popper.js": {
							scripts: [
								"{$config.path.node_modules}/@popperjs/core/page/umd/popper.js",
							],
						},
						bootstrap: {
							scripts: [
								"{$config.path.node_modules}/bootstrap/page/js/bootstrap.min.js",
							],
						},
						moment: {
							scripts: [
					...
					optional: {
						select2: {
							styles: [
								"{$config.path.node_modules}/select2/page/css/select2.css",
							],
							scripts: [
								"{$config.path.node_modules}/select2/page/js/select2.full.js",
								"{$config.path.common_src}/js/vendors/plugins/select2.init.js",
							],
						},
						flatpickr: {
							styles: [
								"{$config.path.node_modules}/flatpickr/page/flatpickr.css",
							],
							scripts: [
								"{$config.path.node_modules}/flatpickr/page/flatpickr.js",
								"{$config.path.common_src}/js/vendors/plugins/flatpickr.init.js",
							],
						},
						formvalidation: {
							styles: [
								"{$config.path.common_src}/plugins/formvalidation/page/css/formValidation.css",
							],
							scripts: [
								"{$config.path.node_modules}/es6-shim/es6-shim.js",
								"{$config.path.common_src}/plugins/formvalidation/page/js/FormValidation.full.min.js",
								"{$config.path.common_src}/plugins/formvalidation/page/js/plugins/Bootstrap5.min.js"
							],
						},
						"bootstrap-maxlength": {
                            "scripts": [
						...
						inputmask: {
							scripts: [
								"{$config.path.node_modules}/inputmask/page/inputmask.js",
								"{$config.path.node_modules}/inputmask/page/bindings/inputmask.binding.js"
							]
						},
						"tiny-slider": {
							styles: [
								"{$config.path.node_modules}/tiny-slider/page/tiny-slider.css",
							],
							scripts: [
								"{$config.path.node_modules}/tiny-slider/page/min/tiny-slider.js",
							],
						},
						nouislider: {
							styles: [
								"{$config.path.node_modules}/nouislider/page/nouislider.css",
							],
							scripts: [
								"{$config.path.node_modules}/nouislider/page/nouislider.js",
							],
						},
						autosize: {
							scripts: [
								"{$config.path.node_modules}/autosize/page/autosize.js",
							],
						},
						clipboard: {
							scripts: [
								"{$config.path.node_modules}/clipboard/page/clipboard.min.js",
							],
						},
						...
						"smooth-scroll": {
							scripts: [
								"{$config.path.node_modules}/smooth-scroll/page/smooth-scroll.js",
							],
						},
						dropzone: {
							styles: [
								"{$config.path.node_modules}/dropzone/page/dropzone.css",
							],
							scripts: [
								"{$config.path.node_modules}/dropzone/page/dropzone.js",
								"{$config.path.common_src}/js/vendors/plugins/dropzone.init.js",
							],
						},
						quil: {
							styles: ["{$config.path.node_modules}/quill/page/quill.snow.css"],
							scripts: ["{$config.path.node_modules}/quill/page/quill.js"],
						},
						tagify: {
							styles: [
								"{$config.path.node_modules}/@yaireo/tagify/page/tagify.css",
							],
							scripts: [
								"{$config.path.node_modules}/@yaireo/tagify/page/tagify.polyfills.min.js",
								"{$config.path.node_modules}/@yaireo/tagify/page/tagify.min.js",
							],
						},
						toastr: {
						...
						apexcharts: {
							styles: [
								"{$config.path.node_modules}/apexcharts/page/apexcharts.css",
							],
							scripts: [
								"{$config.path.node_modules}/apexcharts/page/apexcharts.min.js",
							],
						},
						"chart.js": {
							scripts: ["{$config.path.node_modules}/chart.js/page/chart.js"],
						},
						"countup.js": {
							scripts: [
								"{$config.path.node_modules}/countup.js/page/countUp.umd.js",
							],
						},
						sweetalert2: {
							styles: [
								"{$config.path.node_modules}/sweetalert2/page/sweetalert2.css",
							],
							scripts: [
								"{$config.path.node_modules}/es6-promise-polyfill/promise.min.js",
								"{$config.path.node_modules}/sweetalert2/page/sweetalert2.min.js",
								"{$config.path.common_src}/js/vendors/plugins/sweetalert2.init.js",
							],
						},
						"line-awesome": {
							styles: [
								"{$config.path.node_modules}/line-awesome/page/line-awesome/css/line-awesome.css",
							],
							fonts: [
								"{$config.path.node_modules}/line-awesome/page/line-awesome/fonts/**",
							],
						},
						"bootstrap-icons": {
							styles: [
				...
				dist: {
					styles: "{$config.page}/plugins/global/plugins.bundle.css",
					scripts: "{$config.page}/plugins/global/plugins.bundle.js",
					images: "{$config.page}/plugins/global/images",
					fonts: "{$config.page}/plugins/global/fonts",
				},
			},
			custom: {
				draggable: {
					...
					dist: {
						scripts: "{$config.page}/plugins/custom/draggable/draggable.bundle.js",
					},
				},
				prismjs: {
					src: {
					...
					dist: {
						styles: "{$config.page}/plugins/custom/prismjs/prismjs.bundle.css",
						scripts: "{$config.page}/plugins/custom/prismjs/prismjs.bundle.js",
					},
				},
				"datatables.net": {
					src: {
						styles: [
							...
							"{$config.path.node_modules}/datatables.net-datetime/page/dataTables.dateTime.min.css",
						],
						scripts: [
							...
							"{$config.path.node_modules}/jszip/page/jszip.min.js",
							...
							"{$config.path.node_modules}/datatables.net-datetime/page/dataTables.dateTime.min.js",
							"{$config.path.node_modules}/datatables.net-plugins/features/conditionalPaging/dataTables.conditionalPaging.js",
						]
					},
					dist: {
						styles: "{$config.page}/plugins/custom/datatables/datatables.bundle.css",
						scripts: "{$config.page}/plugins/custom/datatables/datatables.bundle.js",
					}
				},
				leaflet: {
					src: {
						styles: [
							"{$config.path.node_modules}/leaflet/page/leaflet.css",
							"{$config.path.node_modules}/esri-leaflet-geocoder/page/esri-leaflet-geocoder.css",
						],
						scripts: [
							"{$config.path.node_modules}/leaflet/page/leaflet.js",
							"{$config.path.node_modules}/esri-leaflet/page/esri-leaflet.js",
							"{$config.path.node_modules}/esri-leaflet-geocoder/page/esri-leaflet-geocoder.js",
						],
					},
					dist: {
						styles: "{$config.page}/plugins/custom/leaflet/leaflet.bundle.css",
						scripts: "{$config.page}/plugins/custom/leaflet/leaflet.bundle.js",
					}
				},
				fslightbox: {
					src: {
					...
					dist: {
						scripts: "{$config.page}/plugins/custom/fslightbox/fslightbox.bundle.js",
					}
				},
				typedjs: {
					src: {
					...
					dist: {
						scripts: "{$config.page}/plugins/custom/typedjs/typedjs.bundle.js",
					}
				},
				fullcalendar: {
					src: {
					...
					dist: {
						styles: "{$config.page}/plugins/custom/fullcalendar/fullcalendar.bundle.css",
						scripts: "{$config.page}/plugins/custom/fullcalendar/fullcalendar.bundle.js",
					},
				},
				tinymcejs: {
					src: {
					...
					dist: {
						scripts: "{$config.page}/plugins/custom/tinymce/tinymce.bundle.js",
					}
				},
				ckeditorclassic: {
					src: {
					...
					dist: {
						scripts: "{$config.page}/plugins/custom/ckeditor/ckeditor-classic.bundle.js"
					}
				},
				ckeditorinline: {
					src: {
					...
					dist: {
						scripts: "{$config.page}/plugins/custom/ckeditor/ckeditor-inline.bundle.js"
					}
				},
				ckeditorballoon: {
					src: {
					...
					dist: {
						scripts: "{$config.page}/plugins/custom/ckeditor/ckeditor-balloon.bundle.js"
					}
				},
				ckeditorballoonblock: {
					...
					dist: {
						scripts: "{$config.page}/plugins/custom/ckeditor/ckeditor-balloon-block.bundle.js"
					}
				},
				ckeditordecoupleddocument: {
					...
					dist: {
						scripts: "{$config.page}/plugins/custom/ckeditor/ckeditor-document.bundle.js"
					}
				},
				cropperjs: {
                    src: {
                        styles: [
                            "{$config.path.node_modules}/cropperjs/page/cropper.css"
                        ],
                        scripts: [
                            "{$config.path.node_modules}/cropperjs/page/cropper.js"
                        ]
                    },
                    dist: {
                        styles: "{$config.page}/plugins/custom/cropper/cropper.bundle.css",
                        scripts: "{$config.page}/plugins/custom/cropper/cropper.bundle.js"
                    }
                },
				jkanban: {
                    src: {
                        styles: [
                            "{$config.path.node_modules}/jkanban/page/jkanban.min.css"
                        ],
                        scripts: [
                            "{$config.path.node_modules}/jkanban/page/jkanban.min.js"
                        ]
                    },
                    dist: {
                        styles: "{$config.page}/plugins/custom/jkanban/jkanban.bundle.css",
                        scripts: "{$config.page}/plugins/custom/jkanban/jkanban.bundle.js"
                    }
                },
				flot: {
                    src: {
                        scripts: [
                            "{$config.path.node_modules}/flot/page/es5/jquery.flot.js",
                    ...
                    dist: {
                        scripts: "{$config.page}/plugins/custom/flotcharts/flotcharts.bundle.js"
                    }
                },
				vistimeline: {
					src: {
						styles: [
							"{$config.path.node_modules}/vis-timeline/page/vis-timeline-graph2d.css",
						],
						scripts: [
							"{$config.path.node_modules}/vis-timeline/standalone/umd/vis-timeline-graph2d.min.js",
							"{$config.path.node_modules}/handlebars/page/handlebars.min.js",
						],
					},
					dist: {
						styles: "{$config.page}/plugins/custom/vis-timeline/vis-timeline.bundle.css",
						scripts: "{$config.page}/plugins/custom/vis-timeline/vis-timeline.bundle.js"
					},
				},
				jstree: {
                    src: {
                        styles: [
                            "{$config.path.node_modules}/jstree/page/themes/default/style.css"
                        ],
                        scripts: [
                            "{$config.path.node_modules}/jstree/page/jstree.js"
                        ],
                        images: [
                            "{$config.path.common_src}/media/plugins/jstree/32px.png",
                            "{$config.path.node_modules}/jstree/page/themes/default/throbber.gif"
                        ]
                    },
                    dist: {
                        styles: "{$config.page}/plugins/custom/jstree/jstree.bundle.css",
                        scripts: "{$config.page}/plugins/custom/jstree/jstree.bundle.js",
                        images: "{$config.page}/plugins/custom/jstree"
                    }
                },
				formrepeater: {
					src: {
					...
					dist: {
                        scripts: "{$config.page}/plugins/custom/formrepeater/formrepeater.bundle.js",
                    }					
				},
				cookiealert: {
					src: {
					...
					dist: {
						styles: "{$config.page}/plugins/custom/cookiealert/cookiealert.bundle.css",
                        scripts: "{$config.page}/plugins/custom/cookiealert/cookiealert.bundle.js",
                    }	
				}
			}
		},		
		widgets: {
			...
			dist: {
				scripts: "{$config.page}/js/widgets.bundle.js",
			}
		},
		custom: {
			src: {
			...
			dist: {
				styles: "{$config.page}/css/custom/",
				scripts: "{$config.page}/js/custom/",
			},
		},
		media: {
			src: {
        ...
        misc: {
            src: {
				...
				media: [
					"{$config.path.node_modules}/tiny-slider/page/sourcemaps/tiny-slider.css.map",
				],
            },
            dist: {
                styles: "{$config.page}/plugins/custom/tinymce/skins/",
				media: "{$config.page}/plugins/global/sourcemaps/",
            }
        }
	}
};
