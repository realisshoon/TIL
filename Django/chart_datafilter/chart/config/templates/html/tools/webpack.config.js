    ...
    return {
        ...
        resolve: {
            alias: {
                ...
                '@': [demoPath, corePath],
                'handlebars': 'handlebars/page/handlebars.js',
            },
            extensions: ['.js', '.scss'],
            fallback: {
                util: false,
...
function copyFolders() {
    ...
    if (fs.existsSync(path.resolve(__dirname, 'node_modules') + '/summernote/page/font')) {
        options.push({
            // copy summernote fonts
            from: path.resolve(__dirname, 'node_modules') + '/summernote/page/font',
    ...
    extraPlugins.push(new MergeIntoSingle({
        files: {
            'plugins/custom/datatables/datatables.bundle.js': [
                ...
                "node_modules/jszip/page/jszip.min.js",
                ...
                "node_modules/datatables.net-datetime/page/dataTables.dateTime.min.js",
            ],
            ...
            'plugins/custom/datatables/datatables.bundle.css': [
                ...
                "node_modules/datatables.net-datetime/page/dataTables.dateTime.min.css",
            ],
